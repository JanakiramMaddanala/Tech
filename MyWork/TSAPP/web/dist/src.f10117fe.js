...
function () {
  ...
  Model.prototype.save = function () {
    ...
    var user = this.attributes.getAll();
    this.sync.save(user).then(function (response) {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
function (_super) {
  ...
  User.buidlUserCollection = function () {
...
function () {
  ...
  View.prototype.bindModel = function (model) {
    var _this = this;
...
users.fetch(); // const user = User.buildUser({ id: 1, name: 'Janakiram', age: 26 });
